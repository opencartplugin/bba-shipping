<div class="row">
  ...
  <div class="col-sm-6">
    ...
    <div class="form-group required">
      <label class="control-label" for="input-payment-bbacountry"><?php echo $entry_country; ?></label>
      <select name="bbacountry" id="input-payment-bbacountry" class="form-control" style="width: 100%;">
      </select>
    </div>
    <div class="form-group">
      <label class="control-label" for="input-payment-bbastate"><?php echo $entry_state; ?></label>
      <select name="bbastate" id="input-payment-bbastate" class="form-control" style="width: 100%;">
      </select>
    </div>
    <div class="form-group required">
      <label class="control-label" for="input-payment-bbapostcode"><?php echo $entry_postcode; ?></label>
      <select name="bbapostcode" id="input-payment-bbapostcode" class="form-control" style="width: 100%;">
      </select>
    </div>

    <div class="form-group required">
      <label class="control-label" for="input-payment-bbacity"><?php echo $entry_city; ?></label>
