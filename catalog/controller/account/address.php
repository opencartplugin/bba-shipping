...
class ControllerAccountAddress extends Controller {
	...
	protected function getForm() {
		...
		//frd
		if (isset($this->request->post['bbacountry'])) {
			$data['bbacountry'] = $this->request->post['bbacountry'];
		} elseif(!empty($address_info)) {
			$data['bbacountry'] = $address_info['bbacountry'];
		} else {
			$data['bbacountry'] = '';
		}
		if (isset($this->request->post['bbacity'])) {
			$data['bbacity'] = $this->request->post['bbacity'];
		} elseif(!empty($address_info)) {
			$data['bbacity'] = $address_info['bbacity'];
		} else {
			$data['bbacity'] = '';
		}
		if (isset($this->request->post['bbapostcode'])) {
			$data['bbapostcode'] = $this->request->post['bbapostcode'];
		} elseif(!empty($address_info)) {
			$data['bbapostcode'] = $address_info['bbapostcode'];
		} else {
			$data['bbapostcode'] = '';
		}
