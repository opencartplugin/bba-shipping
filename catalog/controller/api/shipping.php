	...
	public function address() {
		...
		if ($this->cart->hasShipping()) {
			if (!isset($this->session->data['api_id'])) {
				...
				//frd
				if ($this->request->post['bbacountry'] == '') {
					$json['error']['bbacountry'] = $this->language->get('error_country');
				}
				if ($this->request->post['bbapostcode'] == '') {
					$json['error']['bbapostcode'] = $this->language->get('error_postcode');
				}
				if ($this->request->post['bbacity'] == '') {
					$json['error']['bbacity'] = $this->language->get('error_city');
				}
