...
class ControllerCheckoutGuest extends Controller {
	public function index() {
		...
		$data['entry_state'] = $this->language->get('entry_state'); //frd
		...
		//$data['postcode'] ='di checkout,guest';
		...
		//frd
		if (isset($this->session->data['payment_address']['bbacountry'])) {
			$data['bbacountry'] = $this->session->data['payment_address']['bbacountry'];
		} elseif (isset($this->session->data['shipping_address']['bbacountry'])) {
			$data['bbacountry'] = $this->session->data['shipping_address']['bbacountry'];
		} else {
			$data['bbacountry'] = '';
		}

		if (isset($this->session->data['payment_address']['bbacity'])) {
			$data['bbacity'] = $this->session->data['payment_address']['bbacity'];
		} elseif (isset($this->session->data['shipping_address']['bbacity'])) {
			$data['bbacity'] = $this->session->data['shipping_address']['bbacity'];
		} else {
			$data['bbacity'] = '';
		}

		if (isset($this->session->data['payment_address']['bbapostcode'])) {
			$data['bbapostcode'] = $this->session->data['payment_address']['bbapostcode'];
		} elseif (isset($this->session->data['shipping_address']['bbapostcode'])) {
	...
	public function save() {
		...
		if (!$json) {
			...
			//frd
			$this->load->model('localisation/country');
			$country = $this->model_localisation_country->getCountryByCode($this->request->post['bbacountry']);
			$this->request->post['country_id'] = $country['country_id'];
			$this->request->post['postcode'] = $this->request->post['bbapostcode'];
			$this->request->post['zone_id'] = null;
			if ($country) {
				$bbaaddress = $this->model_localisation_country->getBBAAddress($this->request->post['bbacountry'], $this->request->post['bbapostcode']);
				$databba = array();
				foreach ($bbaaddress['content'] as $d) {
					if ($d['id'] == $this->request->post['bbacity']) {
						$databba = $d;
						break;
					}
				}
				$this->request->post['city']=$databba['name'];
			...
			$this->session->data['payment_address']['bbacity'] = $this->request->post['bbacity'];
			$this->session->data['payment_address']['bbacountry'] = $this->request->post['bbacountry'];
			$this->session->data['payment_address']['bbapostcode'] = $this->request->post['bbapostcode'];
			//*/
			...
			$this->session->data['payment_address']['postcode'] = $this->request->post['bbapostcode'];
			...
			if ($country) {
				...
				$this->session->data['payment_address']['city']=$databba['name'];
				if (isset($databba['state']['name'])) {
					$this->load->model('localisation/zone');
					$zone = $this->model_localisation_zone->getZoneByName($country['country_id'], $databba['state']['name']);
			...
			if ($this->session->data['guest']['shipping_address']) {
				...
				$this->session->data['shipping_address']['bbacity'] = $this->request->post['bbacity'];
				$this->session->data['shipping_address']['bbacountry'] = $this->request->post['bbacountry'];
				$this->session->data['shipping_address']['bbapostcode'] = $this->request->post['bbapostcode'];
				//
				...
				$this->session->data['shipping_address']['postcode'] = $this->request->post['bbapostcode'];
				...
				if ($country) {
					...
					$this->session->data['shipping_address']['city']=$databba['name'];
					if (isset($databba['state']['name'])) {
						$this->load->model('localisation/zone');
						$zone = $this->model_localisation_zone->getZoneByName($country['country_id'], $databba['state']['name']);
