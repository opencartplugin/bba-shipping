      ...
      <div class="panel-body">
        <form class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            -->
            <!--frd-->
            <input type="hidden" name="city" value="" id="input-payment-city" class="form-control" />
            <input type="hidden" name="postcode" value="" id="input-payment-postcode" class="form-control" />
            <input type="hidden" name="country_id" value="" id="input-payment-country" class="form-control" />
            <input type="hidden" name="zone_id" value="" id="input-payment-zone" class="form-control" />

            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-payment-bbacountry"><?php echo $entry_country; ?></label>
              <div class="col-sm-10">
                <select name="bbacountry" id="input-payment-bbacountry" class="form-control" style="width: 100%;">
                </select>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-payment-bbastate"><?php echo $entry_state; ?></label>
              <div class="col-sm-10">
                <select name="bbastate" id="input-payment-bbastate" class="form-control" style="width: 100%;">
                </select>
              </div>
            </div>
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-payment-bbapostcode"><?php echo $entry_postcode; ?></label>
              <div class="col-sm-10">
                <select name="bbapostcode" id="input-payment-bbapostcode" class="form-control" style="width: 100%;">
                </select>
              </div>
            </div>

            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-payment-bbacity"><?php echo $entry_city; ?></label>
              <div class="col-sm-10">
                <select name="bbacity" id="input-payment-bbacity" class="form-control" style="width: 100%;">
                </select>
              </div>
            </div>
            <script type="text/javascript">
            var BBALogistics_Address_Field = BBALogistics_Address_Form.field();
            var field = new BBALogistics_Address_Field( "#input-payment-bbacountry", "#input-payment-bbastate", "#input-payment-bbapostcode", "#input-payment-bbacity" );
            // To add initial values
            <?php if (isset($payment_bbacountry) && isset($payment_bbapostcode) && isset($payment_bbacity)) { ?>
              field.value({ country: "<?php echo $payment_bbacountry;?>", state: "<?php echo $payment_bbastate;?>", postcode: "<?php echo $payment_bbapostcode;?>", city: "<?php echo $payment_bbacity;?>" });
            <?php } ?>
            var address = new BBALogistics_Address_Form( field );
                address.init({ ajaxUrl: "<?php echo $store_url; ?>index.php?route=api/bbashipping/addressapi" });
            </script>
            ...
            -->
            <input type="hidden" name="city" value="" id="input-shipping-city" class="form-control" />
            <input type="hidden" name="postcode" value="" id="input-shipping-postcode" class="form-control" />
            <input type="hidden" name="country_id" value="" id="input-shipping-country" class="form-control" />
            <input type="hidden" name="zone_id" value="" id="input-shipping-zone" class="form-control" />

            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-shipping-bbacountry"><?php echo $entry_country; ?></label>
              <div class="col-sm-10">
                <select name="bbacountry" id="input-shipping-bbacountry" class="form-control" style="width: 100%;">
                </select>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-shipping-bbastate"><?php echo $entry_state; ?></label>
              <div class="col-sm-10">
                <select name="bbastate" id="input-shipping-bbastate" class="form-control" style="width: 100%;">
                </select>
              </div>
            </div>
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-shipping-bbapostcode"><?php echo $entry_postcode; ?></label>
              <div class="col-sm-10">
                <select name="bbapostcode" id="input-shipping-bbapostcode" class="form-control" style="width: 100%;">
                </select>
              </div>
            </div>

            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-shipping-bbacity"><?php echo $entry_city; ?></label>
              <div class="col-sm-10">
                <select name="bbacity" id="input-shipping-bbacity" class="form-control" style="width: 100%;">
                </select>
              </div>
            </div>
            <script type="text/javascript">
            var BBALogistics_Address_Field = BBALogistics_Address_Form.field();
            var field = new BBALogistics_Address_Field( "#input-shipping-bbacountry", "#input-shipping-bbastate", "#input-shipping-bbapostcode", "#input-shipping-bbacity" );
            // To add initial values
            <?php if (isset($shipping_bbacountry) && isset($shipping_bbapostcode) && isset($shipping_bbacity)) { ?>
              field.value({ country: "<?php echo $shipping_bbacountry;?>", state: "<?php echo $shipping_bbastate;?>", postcode: "<?php echo $shipping_bbapostcode;?>", city: "<?php echo $shipping_bbacity;?>" });
            <?php } ?>
            var address = new BBALogistics_Address_Form( field );
                address.init({ ajaxUrl: "<?php echo $store_url; ?>index.php?route=api/bbashipping/addressapi" });
            </script>
...
$('select[name=\'payment_address\']').on('change', function() {
	$.ajax({
      ...
      //frd
      $('#tab-payment select[name=\'bbacity\']').val(json['bbacity']);
			$('#tab-payment select[name=\'bbapostcode\']').val(json['bbapostcode']);
			$('#tab-payment select[name=\'bbacountry\']').val(json['bbacountry']);
...
$('select[name=\'shipping_address\']').on('change', function() {
	$.ajax({
      ...
      //frd
      $('#tab-shipping select[name=\'bbacity\']').val(json['bbacity']);
			$('#tab-shipping select[name=\'bbapostcode\']').val(json['bbapostcode']);
			$('#tab-shipping select[name=\'bbacountry\']').val(json['bbacountry']);
