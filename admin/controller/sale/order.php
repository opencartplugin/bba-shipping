...
class ControllerSaleOrder extends Controller {
	...
	public function getForm() {
		...
		if (!empty($order_info)) {
			...
			//frd
			$data['payment_bbacountry'] = $order_info['payment_bbacountry'];
			$data['payment_bbapostcode'] = $order_info['payment_bbapostcode'];
			$data['payment_bbacity'] = $order_info['payment_bbacity'];
			$data['shipping_bbacountry'] = $order_info['shipping_bbacountry'];
			$data['shipping_bbapostcode'] = $order_info['shipping_bbapostcode'];
			$data['shipping_bbacity'] = $order_info['shipping_bbacity'];
			...
			$data['shipping_code'] = '';
			//frd
			$data['payment_bbacountry'] = '';
			$data['payment_bbacity'] = '';
			$data['payment_bbapostcode'] = '';
			$data['shipping_bbacountry'] = '';
			$data['shipping_bbacity'] = '';
			$data['shipping_bbapostcode'] = '';
